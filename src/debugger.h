...
extern const std::unordered_map<std::string, Dbg_cond> dbg_cond_map;
extern const std::unordered_map<Dbg_cond, std::string> dbg_cond_names;
extern const std::unordered_map<u16, std::string> interrupt_names;
class Debugger{
    private:
        int& ticks;
        Memory& mem;
