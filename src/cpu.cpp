...
inline bool is_16bit_src(Addr_mode addr_mode){
    switch(addr_mode){
        case Addr_mode::IMM16: case Addr_mode::REG16: case Addr_mode::REG16_PLUS_IMMe8: case Addr_mode::MEM16_REG:
            return true;
        default:
            return false;
    }
...
Instr Cpu::instr_table[0x100] = {
    ...
    (Instr){(Instr_args){"INC", 0x03, (Operand){Addr_mode::REG16, BC}, (Operand){Addr_mode::IMPL, NO_REG, 1}, Cond::ALWAYS, 2}, &Cpu::ADD},
    (Instr){(Instr_args){"INC", 0x04, (Operand){Addr_mode::REG, B}, (Operand){Addr_mode::IMPL, NO_REG, 1}, Cond::ALWAYS, 2}, &Cpu::ADD},
    (Instr){(Instr_args){"DEC", 0x05, (Operand){Addr_mode::REG, B}, (Operand){Addr_mode::IMPL, NO_REG, 1}, Cond::ALWAYS, 2}, &Cpu::SUB},
    (Instr){(Instr_args){"LD", 0x06, (Operand){Addr_mode::REG, B}, (Operand){Addr_mode::IMM8}}, &Cpu::LD},
    (Instr){(Instr_args){"RLCA", 0x07, (Operand){Addr_mode::REG, A}, (Operand){Addr_mode::IMPL}, Cond::ALWAYS, 2}, &Cpu::ROT},
    (Instr){(Instr_args){"LD", 0x08, (Operand){Addr_mode::MEM_IMM16}, (Operand){Addr_mode::REG16, SP}}, &Cpu::LD},
    (Instr){(Instr_args){"ADD", 0x09, (Operand){Addr_mode::REG16, HL}, (Operand){Addr_mode::REG16, BC}}, &Cpu::ADD},
    (Instr){(Instr_args){"LD", 0x0A, (Operand){Addr_mode::REG, A}, (Operand){Addr_mode::MEM_REG, BC}}, &Cpu::LD},
    (Instr){(Instr_args){"DEC", 0x0B, (Operand){Addr_mode::REG16, BC}, (Operand){Addr_mode::IMPL, NO_REG, 1}, Cond::ALWAYS, 2}, &Cpu::SUB},
    (Instr){(Instr_args){"INC", 0x0C, (Operand){Addr_mode::REG, C}, (Operand){Addr_mode::IMPL, NO_REG, 1}, Cond::ALWAYS, 2}, &Cpu::ADD},
    (Instr){(Instr_args){"DEC", 0x0D, (Operand){Addr_mode::REG, C}, (Operand){Addr_mode::IMPL, NO_REG, 1}, Cond::ALWAYS, 2}, &Cpu::SUB},
    (Instr){(Instr_args){"LD", 0x0E, (Operand){Addr_mode::REG, C}, (Operand){Addr_mode::IMM8}}, &Cpu::LD},
    (Instr){(Instr_args){"RRCA", 0x0F, (Operand){Addr_mode::REG, A}, (Operand){Addr_mode::IMPL}, Cond::ALWAYS, 6}, &Cpu::ROT},
    (Instr){(Instr_args){"STOP", 0x10, (Operand){Addr_mode::IMPL, NO_REG, 1}, (Operand){Addr_mode::IMPL, NO_REG, 1}, Cond::ALWAYS, 4}, &Cpu::STOP},
    (Instr){(Instr_args){"LD", 0x11, (Operand){Addr_mode::REG16, DE}, (Operand){Addr_mode::IMM16}}, &Cpu::LD},
    (Instr){(Instr_args){"LD", 0x12, (Operand){Addr_mode::MEM_REG, DE}, (Operand){Addr_mode::REG, A}}, &Cpu::LD},
    (Instr){(Instr_args){"INC", 0x13, (Operand){Addr_mode::REG16, DE}, (Operand){Addr_mode::IMPL, NO_REG, 1}, Cond::ALWAYS, 2}, &Cpu::ADD},
    (Instr){(Instr_args){"INC", 0x14, (Operand){Addr_mode::REG, D}, (Operand){Addr_mode::IMPL, NO_REG, 1}, Cond::ALWAYS, 2}, &Cpu::ADD},
    (Instr){(Instr_args){"DEC", 0x15, (Operand){Addr_mode::REG, D}, (Operand){Addr_mode::IMPL, NO_REG, 1}, Cond::ALWAYS, 2}, &Cpu::SUB},
    (Instr){(Instr_args){"LD", 0x16, (Operand){Addr_mode::REG, D}, (Operand){Addr_mode::IMM8}}, &Cpu::LD},
    (Instr){(Instr_args){"RLA", 0x17, (Operand){Addr_mode::REG, A}, (Operand){Addr_mode::IMPL}, Cond::ALWAYS, 0}, &Cpu::ROT},
    (Instr){(Instr_args){"JR", 0x18, (Operand){Addr_mode::IMMe8}}, &Cpu::JP},
    (Instr){(Instr_args){"ADD", 0x19, (Operand){Addr_mode::REG16, HL}, (Operand){Addr_mode::REG16, DE}}, &Cpu::ADD},
    (Instr){(Instr_args){"LD", 0x1A, (Operand){Addr_mode::REG, A}, (Operand){Addr_mode::MEM_REG, DE}}, &Cpu::LD},
    (Instr){(Instr_args){"DEC", 0x1B, (Operand){Addr_mode::REG16, DE}, (Operand){Addr_mode::IMPL, NO_REG, 1}, Cond::ALWAYS, 2}, &Cpu::SUB},
    (Instr){(Instr_args){"INC", 0x1C, (Operand){Addr_mode::REG, E}, (Operand){Addr_mode::IMPL, NO_REG, 1}, Cond::ALWAYS, 2}, &Cpu::ADD},
    (Instr){(Instr_args){"DEC", 0x1D, (Operand){Addr_mode::REG, E}, (Operand){Addr_mode::IMPL, NO_REG, 1}, Cond::ALWAYS, 2}, &Cpu::SUB},
    (Instr){(Instr_args){"LD", 0x1E, (Operand){Addr_mode::REG, E}, (Operand){Addr_mode::IMM8}}, &Cpu::LD},
    (Instr){(Instr_args){"RRA", 0x1F, (Operand){Addr_mode::REG, A}, (Operand){Addr_mode::IMPL}, Cond::ALWAYS, 4}, &Cpu::ROT},
    (Instr){(Instr_args){"JR", 0x20, (Operand){Addr_mode::IMMe8}, (Operand){Addr_mode::IMPL, NO_REG, 1}, Cond::NZ}, &Cpu::JP},
    (Instr){(Instr_args){"LD", 0x21, (Operand){Addr_mode::REG16, HL}, (Operand){Addr_mode::IMM16}}, &Cpu::LD},
    (Instr){(Instr_args){"LD", 0x22, (Operand){Addr_mode::MEM_REG_INC, HL, 0}, (Operand){Addr_mode::REG, A}}, &Cpu::LD},
    (Instr){(Instr_args){"INC", 0x23, (Operand){Addr_mode::REG16, HL}, (Operand){Addr_mode::IMPL, NO_REG, 1}, Cond::ALWAYS, 2}, &Cpu::ADD},
    (Instr){(Instr_args){"INC", 0x24, (Operand){Addr_mode::REG, H}, (Operand){Addr_mode::IMPL, NO_REG, 1}, Cond::ALWAYS, 2}, &Cpu::ADD},
    (Instr){(Instr_args){"DEC", 0x25, (Operand){Addr_mode::REG, H}, (Operand){Addr_mode::IMPL, NO_REG, 1}, Cond::ALWAYS, 2}, &Cpu::SUB},
    (Instr){(Instr_args){"LD", 0x26, (Operand){Addr_mode::REG, H}, (Operand){Addr_mode::IMM8}}, &Cpu::LD},
    (Instr){(Instr_args){"DAA", 0x27}, &Cpu::DAA},
    (Instr){(Instr_args){"JR", 0x28, (Operand){Addr_mode::IMMe8}, (Operand){Addr_mode::IMPL, NO_REG, 1}, Cond::Z}, &Cpu::JP},
    (Instr){(Instr_args){"ADD", 0x29, (Operand){Addr_mode::REG16, HL}, (Operand){Addr_mode::REG16, HL}}, &Cpu::ADD},
    (Instr){(Instr_args){"LD", 0x2A, (Operand){Addr_mode::REG, A}, (Operand){Addr_mode::MEM_REG_INC, HL, 0}}, &Cpu::LD},
    (Instr){(Instr_args){"DEC", 0x2B, (Operand){Addr_mode::REG16, HL}, (Operand){Addr_mode::IMPL, NO_REG, 1}, Cond::ALWAYS, 2}, &Cpu::SUB},
    (Instr){(Instr_args){"INC", 0x2C, (Operand){Addr_mode::REG, L}, (Operand){Addr_mode::IMPL, NO_REG, 1}, Cond::ALWAYS, 2}, &Cpu::ADD},
    (Instr){(Instr_args){"DEC", 0x2D, (Operand){Addr_mode::REG, L}, (Operand){Addr_mode::IMPL, NO_REG, 1}, Cond::ALWAYS, 2}, &Cpu::SUB},
    (Instr){(Instr_args){"LD", 0x2E, (Operand){Addr_mode::REG, L}, (Operand){Addr_mode::IMM8}}, &Cpu::LD},
    (Instr){(Instr_args){"CPL", 0x2F}, &Cpu::CPL},
    (Instr){(Instr_args){"JR", 0x30, (Operand){Addr_mode::IMMe8}, (Operand){Addr_mode::IMPL, NO_REG, 1}, Cond::NC}, &Cpu::JP},
    (Instr){(Instr_args){"LD", 0x31, (Operand){Addr_mode::REG16, SP}, (Operand){Addr_mode::IMM16}}, &Cpu::LD},
    (Instr){(Instr_args){"LD", 0x32, (Operand){Addr_mode::MEM_REG_DEC, HL, 0}, (Operand){Addr_mode::REG, A}}, &Cpu::LD},
    (Instr){(Instr_args){"INC", 0x33, (Operand){Addr_mode::REG16, SP}, (Operand){Addr_mode::IMPL, NO_REG, 1}, Cond::ALWAYS, 2}, &Cpu::ADD},
    (Instr){(Instr_args){"INC", 0x34, (Operand){Addr_mode::MEM_REG, HL}, (Operand){Addr_mode::IMPL, NO_REG, 1}, Cond::ALWAYS, 2}, &Cpu::ADD},
    (Instr){(Instr_args){"DEC", 0x35, (Operand){Addr_mode::MEM_REG, HL}, (Operand){Addr_mode::IMPL, NO_REG, 1}, Cond::ALWAYS, 2}, &Cpu::SUB},
    (Instr){(Instr_args){"LD", 0x36, (Operand){Addr_mode::MEM_REG, HL}, (Operand){Addr_mode::IMM8}}, &Cpu::LD},
    (Instr){(Instr_args){"SCF", 0x37}, &Cpu::SCF},
    (Instr){(Instr_args){"JR", 0x38, (Operand){Addr_mode::IMMe8}, (Operand){Addr_mode::IMPL, NO_REG, 1}, Cond::C}, &Cpu::JP},
    (Instr){(Instr_args){"ADD", 0x39, (Operand){Addr_mode::REG16, HL}, (Operand){Addr_mode::REG16, SP}}, &Cpu::ADD},
    (Instr){(Instr_args){"LD", 0x3A, (Operand){Addr_mode::REG, A}, (Operand){Addr_mode::MEM_REG_DEC, HL, 0}}, &Cpu::LD},
    (Instr){(Instr_args){"DEC", 0x3B, (Operand){Addr_mode::REG16, SP}, (Operand){Addr_mode::IMPL, NO_REG, 1}, Cond::ALWAYS, 2}, &Cpu::SUB},
    (Instr){(Instr_args){"INC", 0x3C, (Operand){Addr_mode::REG, A}, (Operand){Addr_mode::IMPL, NO_REG, 1}, Cond::ALWAYS, 2}, &Cpu::ADD},
    (Instr){(Instr_args){"DEC", 0x3D, (Operand){Addr_mode::REG, A}, (Operand){Addr_mode::IMPL, NO_REG, 1}, Cond::ALWAYS, 2}, &Cpu::SUB},
    (Instr){(Instr_args){"LD", 0x3E, (Operand){Addr_mode::REG, A}, (Operand){Addr_mode::IMM8}}, &Cpu::LD},
    (Instr){(Instr_args){"CCF", 0x3F}, &Cpu::CCF},
    (Instr){(Instr_args){"LD", 0x40, (Operand){Addr_mode::REG, B}, (Operand){Addr_mode::REG, B}}, &Cpu::LD},
    (Instr){(Instr_args){"LD", 0x41, (Operand){Addr_mode::REG, B}, (Operand){Addr_mode::REG, C}}, &Cpu::LD},
    (Instr){(Instr_args){"LD", 0x42, (Operand){Addr_mode::REG, B}, (Operand){Addr_mode::REG, D}}, &Cpu::LD},
    (Instr){(Instr_args){"LD", 0x43, (Operand){Addr_mode::REG, B}, (Operand){Addr_mode::REG, E}}, &Cpu::LD},
    (Instr){(Instr_args){"LD", 0x44, (Operand){Addr_mode::REG, B}, (Operand){Addr_mode::REG, H}}, &Cpu::LD},
    (Instr){(Instr_args){"LD", 0x45, (Operand){Addr_mode::REG, B}, (Operand){Addr_mode::REG, L}}, &Cpu::LD},
    (Instr){(Instr_args){"LD", 0x46, (Operand){Addr_mode::REG, B}, (Operand){Addr_mode::MEM_REG, HL}}, &Cpu::LD},
    (Instr){(Instr_args){"LD", 0x47, (Operand){Addr_mode::REG, B}, (Operand){Addr_mode::REG, A}}, &Cpu::LD},
    (Instr){(Instr_args){"LD", 0x48, (Operand){Addr_mode::REG, C}, (Operand){Addr_mode::REG, B}}, &Cpu::LD},
    (Instr){(Instr_args){"LD", 0x49, (Operand){Addr_mode::REG, C}, (Operand){Addr_mode::REG, C}}, &Cpu::LD},
    (Instr){(Instr_args){"LD", 0x4A, (Operand){Addr_mode::REG, C}, (Operand){Addr_mode::REG, D}}, &Cpu::LD},
    (Instr){(Instr_args){"LD", 0x4B, (Operand){Addr_mode::REG, C}, (Operand){Addr_mode::REG, E}}, &Cpu::LD},
    (Instr){(Instr_args){"LD", 0x4C, (Operand){Addr_mode::REG, C}, (Operand){Addr_mode::REG, H}}, &Cpu::LD},
    (Instr){(Instr_args){"LD", 0x4D, (Operand){Addr_mode::REG, C}, (Operand){Addr_mode::REG, L}}, &Cpu::LD},
    (Instr){(Instr_args){"LD", 0x4E, (Operand){Addr_mode::REG, C}, (Operand){Addr_mode::MEM_REG, HL}}, &Cpu::LD},
    (Instr){(Instr_args){"LD", 0x4F, (Operand){Addr_mode::REG, C}, (Operand){Addr_mode::REG, A}}, &Cpu::LD},
    (Instr){(Instr_args){"LD", 0x50, (Operand){Addr_mode::REG, D}, (Operand){Addr_mode::REG, B}}, &Cpu::LD},
    (Instr){(Instr_args){"LD", 0x51, (Operand){Addr_mode::REG, D}, (Operand){Addr_mode::REG, C}}, &Cpu::LD},
    (Instr){(Instr_args){"LD", 0x52, (Operand){Addr_mode::REG, D}, (Operand){Addr_mode::REG, D}}, &Cpu::LD},
    (Instr){(Instr_args){"LD", 0x53, (Operand){Addr_mode::REG, D}, (Operand){Addr_mode::REG, E}}, &Cpu::LD},
    (Instr){(Instr_args){"LD", 0x54, (Operand){Addr_mode::REG, D}, (Operand){Addr_mode::REG, H}}, &Cpu::LD},
    (Instr){(Instr_args){"LD", 0x55, (Operand){Addr_mode::REG, D}, (Operand){Addr_mode::REG, L}}, &Cpu::LD},
    (Instr){(Instr_args){"LD", 0x56, (Operand){Addr_mode::REG, D}, (Operand){Addr_mode::MEM_REG, HL}}, &Cpu::LD},
    (Instr){(Instr_args){"LD", 0x57, (Operand){Addr_mode::REG, D}, (Operand){Addr_mode::REG, A}}, &Cpu::LD},
    (Instr){(Instr_args){"LD", 0x58, (Operand){Addr_mode::REG, E}, (Operand){Addr_mode::REG, B}}, &Cpu::LD},
    (Instr){(Instr_args){"LD", 0x59, (Operand){Addr_mode::REG, E}, (Operand){Addr_mode::REG, C}}, &Cpu::LD},
    (Instr){(Instr_args){"LD", 0x5A, (Operand){Addr_mode::REG, E}, (Operand){Addr_mode::REG, D}}, &Cpu::LD},
    (Instr){(Instr_args){"LD", 0x5B, (Operand){Addr_mode::REG, E}, (Operand){Addr_mode::REG, E}}, &Cpu::LD},
    (Instr){(Instr_args){"LD", 0x5C, (Operand){Addr_mode::REG, E}, (Operand){Addr_mode::REG, H}}, &Cpu::LD},
    (Instr){(Instr_args){"LD", 0x5D, (Operand){Addr_mode::REG, E}, (Operand){Addr_mode::REG, L}}, &Cpu::LD},
    (Instr){(Instr_args){"LD", 0x5E, (Operand){Addr_mode::REG, E}, (Operand){Addr_mode::MEM_REG, HL}}, &Cpu::LD},
    (Instr){(Instr_args){"LD", 0x5F, (Operand){Addr_mode::REG, E}, (Operand){Addr_mode::REG, A}}, &Cpu::LD},
    (Instr){(Instr_args){"LD", 0x60, (Operand){Addr_mode::REG, H}, (Operand){Addr_mode::REG, B}}, &Cpu::LD},
    (Instr){(Instr_args){"LD", 0x61, (Operand){Addr_mode::REG, H}, (Operand){Addr_mode::REG, C}}, &Cpu::LD},
    (Instr){(Instr_args){"LD", 0x62, (Operand){Addr_mode::REG, H}, (Operand){Addr_mode::REG, D}}, &Cpu::LD},
    (Instr){(Instr_args){"LD", 0x63, (Operand){Addr_mode::REG, H}, (Operand){Addr_mode::REG, E}}, &Cpu::LD},
    (Instr){(Instr_args){"LD", 0x64, (Operand){Addr_mode::REG, H}, (Operand){Addr_mode::REG, H}}, &Cpu::LD},
    (Instr){(Instr_args){"LD", 0x65, (Operand){Addr_mode::REG, H}, (Operand){Addr_mode::REG, L}}, &Cpu::LD},
    (Instr){(Instr_args){"LD", 0x66, (Operand){Addr_mode::REG, H}, (Operand){Addr_mode::MEM_REG, HL}}, &Cpu::LD},
    (Instr){(Instr_args){"LD", 0x67, (Operand){Addr_mode::REG, H}, (Operand){Addr_mode::REG, A}}, &Cpu::LD},
    (Instr){(Instr_args){"LD", 0x68, (Operand){Addr_mode::REG, L}, (Operand){Addr_mode::REG, B}}, &Cpu::LD},
    (Instr){(Instr_args){"LD", 0x69, (Operand){Addr_mode::REG, L}, (Operand){Addr_mode::REG, C}}, &Cpu::LD},
    (Instr){(Instr_args){"LD", 0x6A, (Operand){Addr_mode::REG, L}, (Operand){Addr_mode::REG, D}}, &Cpu::LD},
    (Instr){(Instr_args){"LD", 0x6B, (Operand){Addr_mode::REG, L}, (Operand){Addr_mode::REG, E}}, &Cpu::LD},
    (Instr){(Instr_args){"LD", 0x6C, (Operand){Addr_mode::REG, L}, (Operand){Addr_mode::REG, H}}, &Cpu::LD},
    (Instr){(Instr_args){"LD", 0x6D, (Operand){Addr_mode::REG, L}, (Operand){Addr_mode::REG, L}}, &Cpu::LD},
    (Instr){(Instr_args){"LD", 0x6E, (Operand){Addr_mode::REG, L}, (Operand){Addr_mode::MEM_REG, HL}}, &Cpu::LD},
    (Instr){(Instr_args){"LD", 0x6F, (Operand){Addr_mode::REG, L}, (Operand){Addr_mode::REG, A}}, &Cpu::LD},
    (Instr){(Instr_args){"LD", 0x70, (Operand){Addr_mode::MEM_REG, HL}, (Operand){Addr_mode::REG, B}}, &Cpu::LD},
    (Instr){(Instr_args){"LD", 0x71, (Operand){Addr_mode::MEM_REG, HL}, (Operand){Addr_mode::REG, C}}, &Cpu::LD},
    (Instr){(Instr_args){"LD", 0x72, (Operand){Addr_mode::MEM_REG, HL}, (Operand){Addr_mode::REG, D}}, &Cpu::LD},
    (Instr){(Instr_args){"LD", 0x73, (Operand){Addr_mode::MEM_REG, HL}, (Operand){Addr_mode::REG, E}}, &Cpu::LD},
    (Instr){(Instr_args){"LD", 0x74, (Operand){Addr_mode::MEM_REG, HL}, (Operand){Addr_mode::REG, H}}, &Cpu::LD},
    (Instr){(Instr_args){"LD", 0x75, (Operand){Addr_mode::MEM_REG, HL}, (Operand){Addr_mode::REG, L}}, &Cpu::LD},
    (Instr){(Instr_args){"HALT", 0x76}, &Cpu::HALT},
    (Instr){(Instr_args){"LD", 0x77, (Operand){Addr_mode::MEM_REG, HL}, (Operand){Addr_mode::REG, A}}, &Cpu::LD},
    (Instr){(Instr_args){"LD", 0x78, (Operand){Addr_mode::REG, A}, (Operand){Addr_mode::REG, B}}, &Cpu::LD},
    (Instr){(Instr_args){"LD", 0x79, (Operand){Addr_mode::REG, A}, (Operand){Addr_mode::REG, C}}, &Cpu::LD},
    (Instr){(Instr_args){"LD", 0x7A, (Operand){Addr_mode::REG, A}, (Operand){Addr_mode::REG, D}}, &Cpu::LD},
    (Instr){(Instr_args){"LD", 0x7B, (Operand){Addr_mode::REG, A}, (Operand){Addr_mode::REG, E}}, &Cpu::LD},
    (Instr){(Instr_args){"LD", 0x7C, (Operand){Addr_mode::REG, A}, (Operand){Addr_mode::REG, H}}, &Cpu::LD},
    (Instr){(Instr_args){"LD", 0x7D, (Operand){Addr_mode::REG, A}, (Operand){Addr_mode::REG, L}}, &Cpu::LD},
    (Instr){(Instr_args){"LD", 0x7E, (Operand){Addr_mode::REG, A}, (Operand){Addr_mode::MEM_REG, HL}}, &Cpu::LD},
    (Instr){(Instr_args){"LD", 0x7F, (Operand){Addr_mode::REG, A}, (Operand){Addr_mode::REG, A}}, &Cpu::LD},
    (Instr){(Instr_args){"ADD", 0x80, (Operand){Addr_mode::REG, A}, (Operand){Addr_mode::REG, B}}, &Cpu::ADD},
    (Instr){(Instr_args){"ADD", 0x81, (Operand){Addr_mode::REG, A}, (Operand){Addr_mode::REG, C}}, &Cpu::ADD},
    (Instr){(Instr_args){"ADD", 0x82, (Operand){Addr_mode::REG, A}, (Operand){Addr_mode::REG, D}}, &Cpu::ADD},
    (Instr){(Instr_args){"ADD", 0x83, (Operand){Addr_mode::REG, A}, (Operand){Addr_mode::REG, E}}, &Cpu::ADD},
    (Instr){(Instr_args){"ADD", 0x84, (Operand){Addr_mode::REG, A}, (Operand){Addr_mode::REG, H}}, &Cpu::ADD},
    (Instr){(Instr_args){"ADD", 0x85, (Operand){Addr_mode::REG, A}, (Operand){Addr_mode::REG, L}}, &Cpu::ADD},
    (Instr){(Instr_args){"ADD", 0x86, (Operand){Addr_mode::REG, A}, (Operand){Addr_mode::MEM_REG, HL}}, &Cpu::ADD},
    (Instr){(Instr_args){"ADD", 0x87, (Operand){Addr_mode::REG, A}, (Operand){Addr_mode::REG, A}}, &Cpu::ADD},
    (Instr){(Instr_args){"ADC", 0x88, (Operand){Addr_mode::REG, A}, (Operand){Addr_mode::REG, B}, Cond::ALWAYS, 1}, &Cpu::ADD},
    (Instr){(Instr_args){"ADC", 0x89, (Operand){Addr_mode::REG, A}, (Operand){Addr_mode::REG, C}, Cond::ALWAYS, 1}, &Cpu::ADD},
    (Instr){(Instr_args){"ADC", 0x8A, (Operand){Addr_mode::REG, A}, (Operand){Addr_mode::REG, D}, Cond::ALWAYS, 1}, &Cpu::ADD},
    (Instr){(Instr_args){"ADC", 0x8B, (Operand){Addr_mode::REG, A}, (Operand){Addr_mode::REG, E}, Cond::ALWAYS, 1}, &Cpu::ADD},
    (Instr){(Instr_args){"ADC", 0x8C, (Operand){Addr_mode::REG, A}, (Operand){Addr_mode::REG, H}, Cond::ALWAYS, 1}, &Cpu::ADD},
    (Instr){(Instr_args){"ADC", 0x8D, (Operand){Addr_mode::REG, A}, (Operand){Addr_mode::REG, L}, Cond::ALWAYS, 1}, &Cpu::ADD},
    (Instr){(Instr_args){"ADC", 0x8E, (Operand){Addr_mode::REG, A}, (Operand){Addr_mode::MEM_REG, HL}, Cond::ALWAYS, 1}, &Cpu::ADD},
    (Instr){(Instr_args){"ADC", 0x8F, (Operand){Addr_mode::REG, A}, (Operand){Addr_mode::REG, A}, Cond::ALWAYS, 1}, &Cpu::ADD},
    (Instr){(Instr_args){"SUB", 0x90, (Operand){Addr_mode::REG, A}, (Operand){Addr_mode::REG, B}}, &Cpu::SUB},
    (Instr){(Instr_args){"SUB", 0x91, (Operand){Addr_mode::REG, A}, (Operand){Addr_mode::REG, C}}, &Cpu::SUB},
    (Instr){(Instr_args){"SUB", 0x92, (Operand){Addr_mode::REG, A}, (Operand){Addr_mode::REG, D}}, &Cpu::SUB},
    (Instr){(Instr_args){"SUB", 0x93, (Operand){Addr_mode::REG, A}, (Operand){Addr_mode::REG, E}}, &Cpu::SUB},
    (Instr){(Instr_args){"SUB", 0x94, (Operand){Addr_mode::REG, A}, (Operand){Addr_mode::REG, H}}, &Cpu::SUB},
    (Instr){(Instr_args){"SUB", 0x95, (Operand){Addr_mode::REG, A}, (Operand){Addr_mode::REG, L}}, &Cpu::SUB},
    (Instr){(Instr_args){"SUB", 0x96, (Operand){Addr_mode::REG, A}, (Operand){Addr_mode::MEM_REG, HL}}, &Cpu::SUB},
    (Instr){(Instr_args){"SUB", 0x97, (Operand){Addr_mode::REG, A}, (Operand){Addr_mode::REG, A}}, &Cpu::SUB},
    (Instr){(Instr_args){"SBC", 0x98, (Operand){Addr_mode::REG, A}, (Operand){Addr_mode::REG, B}, Cond::ALWAYS, 1}, &Cpu::SUB},
    (Instr){(Instr_args){"SBC", 0x99, (Operand){Addr_mode::REG, A}, (Operand){Addr_mode::REG, C}, Cond::ALWAYS, 1}, &Cpu::SUB},
    (Instr){(Instr_args){"SBC", 0x9A, (Operand){Addr_mode::REG, A}, (Operand){Addr_mode::REG, D}, Cond::ALWAYS, 1}, &Cpu::SUB},
    (Instr){(Instr_args){"SBC", 0x9B, (Operand){Addr_mode::REG, A}, (Operand){Addr_mode::REG, E}, Cond::ALWAYS, 1}, &Cpu::SUB},
    (Instr){(Instr_args){"SBC", 0x9C, (Operand){Addr_mode::REG, A}, (Operand){Addr_mode::REG, H}, Cond::ALWAYS, 1}, &Cpu::SUB},
    (Instr){(Instr_args){"SBC", 0x9D, (Operand){Addr_mode::REG, A}, (Operand){Addr_mode::REG, L}, Cond::ALWAYS, 1}, &Cpu::SUB},
    (Instr){(Instr_args){"SBC", 0x9E, (Operand){Addr_mode::REG, A}, (Operand){Addr_mode::MEM_REG, HL}, Cond::ALWAYS, 1}, &Cpu::SUB},
    (Instr){(Instr_args){"SBC", 0x9F, (Operand){Addr_mode::REG, A}, (Operand){Addr_mode::REG, A}, Cond::ALWAYS, 1}, &Cpu::SUB},
    (Instr){(Instr_args){"AND", 0xA0, (Operand){Addr_mode::REG, A}, (Operand){Addr_mode::REG, B}}, &Cpu::AND},
    (Instr){(Instr_args){"AND", 0xA1, (Operand){Addr_mode::REG, A}, (Operand){Addr_mode::REG, C}}, &Cpu::AND},
    (Instr){(Instr_args){"AND", 0xA2, (Operand){Addr_mode::REG, A}, (Operand){Addr_mode::REG, D}}, &Cpu::AND},
    (Instr){(Instr_args){"AND", 0xA3, (Operand){Addr_mode::REG, A}, (Operand){Addr_mode::REG, E}}, &Cpu::AND},
    (Instr){(Instr_args){"AND", 0xA4, (Operand){Addr_mode::REG, A}, (Operand){Addr_mode::REG, H}}, &Cpu::AND},
    (Instr){(Instr_args){"AND", 0xA5, (Operand){Addr_mode::REG, A}, (Operand){Addr_mode::REG, L}}, &Cpu::AND},
    (Instr){(Instr_args){"AND", 0xA6, (Operand){Addr_mode::REG, A}, (Operand){Addr_mode::MEM_REG, HL}}, &Cpu::AND},
    (Instr){(Instr_args){"AND", 0xA7, (Operand){Addr_mode::REG, A}, (Operand){Addr_mode::REG, A}}, &Cpu::AND},
    (Instr){(Instr_args){"XOR", 0xA8, (Operand){Addr_mode::REG, A}, (Operand){Addr_mode::REG, B}}, &Cpu::XOR},
    (Instr){(Instr_args){"XOR", 0xA9, (Operand){Addr_mode::REG, A}, (Operand){Addr_mode::REG, C}}, &Cpu::XOR},
    (Instr){(Instr_args){"XOR", 0xAA, (Operand){Addr_mode::REG, A}, (Operand){Addr_mode::REG, D}}, &Cpu::XOR},
    (Instr){(Instr_args){"XOR", 0xAB, (Operand){Addr_mode::REG, A}, (Operand){Addr_mode::REG, E}}, &Cpu::XOR},
    (Instr){(Instr_args){"XOR", 0xAC, (Operand){Addr_mode::REG, A}, (Operand){Addr_mode::REG, H}}, &Cpu::XOR},
    (Instr){(Instr_args){"XOR", 0xAD, (Operand){Addr_mode::REG, A}, (Operand){Addr_mode::REG, L}}, &Cpu::XOR},
    (Instr){(Instr_args){"XOR", 0xAE, (Operand){Addr_mode::REG, A}, (Operand){Addr_mode::MEM_REG, HL}}, &Cpu::XOR},
    (Instr){(Instr_args){"XOR", 0xAF, (Operand){Addr_mode::REG, A}, (Operand){Addr_mode::REG, A}}, &Cpu::XOR},
    (Instr){(Instr_args){"OR", 0xB0, (Operand){Addr_mode::REG, A}, (Operand){Addr_mode::REG, B}}, &Cpu::OR},
    (Instr){(Instr_args){"OR", 0xB1, (Operand){Addr_mode::REG, A}, (Operand){Addr_mode::REG, C}}, &Cpu::OR},
    (Instr){(Instr_args){"OR", 0xB2, (Operand){Addr_mode::REG, A}, (Operand){Addr_mode::REG, D}}, &Cpu::OR},
    (Instr){(Instr_args){"OR", 0xB3, (Operand){Addr_mode::REG, A}, (Operand){Addr_mode::REG, E}}, &Cpu::OR},
    (Instr){(Instr_args){"OR", 0xB4, (Operand){Addr_mode::REG, A}, (Operand){Addr_mode::REG, H}}, &Cpu::OR},
    (Instr){(Instr_args){"OR", 0xB5, (Operand){Addr_mode::REG, A}, (Operand){Addr_mode::REG, L}}, &Cpu::OR},
    (Instr){(Instr_args){"OR", 0xB6, (Operand){Addr_mode::REG, A}, (Operand){Addr_mode::MEM_REG, HL}}, &Cpu::OR},
    (Instr){(Instr_args){"OR", 0xB7, (Operand){Addr_mode::REG, A}, (Operand){Addr_mode::REG, A}}, &Cpu::OR},
    (Instr){(Instr_args){"CP", 0xB8, (Operand){Addr_mode::REG, A}, (Operand){Addr_mode::REG, B}}, &Cpu::CP},
    (Instr){(Instr_args){"CP", 0xB9, (Operand){Addr_mode::REG, A}, (Operand){Addr_mode::REG, C}}, &Cpu::CP},
    (Instr){(Instr_args){"CP", 0xBA, (Operand){Addr_mode::REG, A}, (Operand){Addr_mode::REG, D}}, &Cpu::CP},
    (Instr){(Instr_args){"CP", 0xBB, (Operand){Addr_mode::REG, A}, (Operand){Addr_mode::REG, E}}, &Cpu::CP},
    (Instr){(Instr_args){"CP", 0xBC, (Operand){Addr_mode::REG, A}, (Operand){Addr_mode::REG, H}}, &Cpu::CP},
    (Instr){(Instr_args){"CP", 0xBD, (Operand){Addr_mode::REG, A}, (Operand){Addr_mode::REG, L}}, &Cpu::CP},
    (Instr){(Instr_args){"CP", 0xBE, (Operand){Addr_mode::REG, A}, (Operand){Addr_mode::MEM_REG, HL}}, &Cpu::CP},
    (Instr){(Instr_args){"CP", 0xBF, (Operand){Addr_mode::REG, A}, (Operand){Addr_mode::REG, A}}, &Cpu::CP},
    (Instr){(Instr_args){"RET", 0xC0, (Operand){Addr_mode::MEM16_REG, SP}, (Operand){Addr_mode::IMPL}, Cond::NZ, 2}, &Cpu::JP},
    (Instr){(Instr_args){"POP", 0xC1, (Operand){Addr_mode::REG16, BC}, (Operand){Addr_mode::MEM16_REG, SP}, Cond::ALWAYS, 1}, &Cpu::PUSH_POP},
    (Instr){(Instr_args){"JP", 0xC2, (Operand){Addr_mode::IMM16}, (Operand){Addr_mode::IMPL, NO_REG, 0}, Cond::NZ}, &Cpu::JP},
    (Instr){(Instr_args){"JP", 0xC3, (Operand){Addr_mode::IMM16}}, &Cpu::JP},
    (Instr){(Instr_args){"CALL", 0xC4, (Operand){Addr_mode::IMM16}, (Operand){Addr_mode::IMPL}, Cond::NZ, 1}, &Cpu::JP},
    (Instr){(Instr_args){"PUSH", 0xC5, (Operand){Addr_mode::MEM16_REG, SP}, (Operand){Addr_mode::REG16, BC}, Cond::ALWAYS, 0}, &Cpu::PUSH_POP},
    (Instr){(Instr_args){"ADD", 0xC6, (Operand){Addr_mode::REG, A}, (Operand){Addr_mode::IMM8}}, &Cpu::ADD},
    (Instr){(Instr_args){"RST", 0xC7, (Operand){Addr_mode::IMPL_SHOW, NO_REG, 0}, (Operand){Addr_mode::IMPL}, Cond::ALWAYS, 1}, &Cpu::JP},
    (Instr){(Instr_args){"RET", 0xC8, (Operand){Addr_mode::MEM16_REG, SP}, (Operand){Addr_mode::IMPL}, Cond::Z, 2}, &Cpu::JP},
    (Instr){(Instr_args){"RET", 0xC9, (Operand){Addr_mode::MEM16_REG, SP}, (Operand){Addr_mode::IMPL}, Cond::ALWAYS, 2}, &Cpu::JP},
    (Instr){(Instr_args){"JP", 0xCA, (Operand){Addr_mode::IMM16}, (Operand){Addr_mode::IMPL, NO_REG, 0}, Cond::Z}, &Cpu::JP},
    (Instr){(Instr_args){"X_X", 0xCB}, &Cpu::X_X},
    (Instr){(Instr_args){"CALL", 0xCC, (Operand){Addr_mode::IMM16}, (Operand){Addr_mode::IMPL}, Cond::Z, 1}, &Cpu::JP},
    (Instr){(Instr_args){"CALL", 0xCD, (Operand){Addr_mode::IMM16}, (Operand){Addr_mode::IMPL}, Cond::ALWAYS, 1}, &Cpu::JP},
    (Instr){(Instr_args){"ADC", 0xCE, (Operand){Addr_mode::REG, A}, (Operand){Addr_mode::IMM8}, Cond::ALWAYS, 1}, &Cpu::ADD},
    (Instr){(Instr_args){"RST", 0xCF, (Operand){Addr_mode::IMPL_SHOW, NO_REG, 8}, (Operand){Addr_mode::IMPL}, Cond::ALWAYS, 1}, &Cpu::JP},
    (Instr){(Instr_args){"RET", 0xD0, (Operand){Addr_mode::MEM16_REG, SP}, (Operand){Addr_mode::IMPL}, Cond::NC, 2}, &Cpu::JP},
    (Instr){(Instr_args){"POP", 0xD1, (Operand){Addr_mode::REG16, DE}, (Operand){Addr_mode::MEM16_REG, SP}, Cond::ALWAYS, 1}, &Cpu::PUSH_POP},
    (Instr){(Instr_args){"JP", 0xD2, (Operand){Addr_mode::IMM16}, (Operand){Addr_mode::IMPL, NO_REG, 0}, Cond::NC}, &Cpu::JP},
    (Instr){(Instr_args){"X_X", 0xD3}, &Cpu::X_X},
    (Instr){(Instr_args){"CALL", 0xD4, (Operand){Addr_mode::IMM16}, (Operand){Addr_mode::IMPL}, Cond::NC, 1}, &Cpu::JP},
    (Instr){(Instr_args){"PUSH", 0xD5, (Operand){Addr_mode::MEM16_REG, SP}, (Operand){Addr_mode::REG16, DE}, Cond::ALWAYS, 0}, &Cpu::PUSH_POP},
    (Instr){(Instr_args){"SUB", 0xD6, (Operand){Addr_mode::REG, A}, (Operand){Addr_mode::IMM8}}, &Cpu::SUB},
    (Instr){(Instr_args){"RST", 0xD7, (Operand){Addr_mode::IMPL_SHOW, NO_REG, 0x10}, (Operand){Addr_mode::IMPL}, Cond::ALWAYS, 1}, &Cpu::JP},
    (Instr){(Instr_args){"RET", 0xD8, (Operand){Addr_mode::MEM16_REG, SP}, (Operand){Addr_mode::IMPL}, Cond::C, 2}, &Cpu::JP},
    (Instr){(Instr_args){"RETI", 0xD9, (Operand){Addr_mode::MEM16_REG, SP}, (Operand){Addr_mode::IMPL}, Cond::ALWAYS, 3}, &Cpu::JP},
    (Instr){(Instr_args){"JP", 0xDA, (Operand){Addr_mode::IMM16}, (Operand){Addr_mode::IMPL, NO_REG, 0}, Cond::C}, &Cpu::JP},
    (Instr){(Instr_args){"X_X", 0xDB}, &Cpu::X_X},
    (Instr){(Instr_args){"CALL", 0xDC, (Operand){Addr_mode::IMM16}, (Operand){Addr_mode::IMPL}, Cond::C, 1}, &Cpu::JP},
    (Instr){(Instr_args){"X_X", 0xDD}, &Cpu::X_X},
    (Instr){(Instr_args){"SBC", 0xDE, (Operand){Addr_mode::REG, A}, (Operand){Addr_mode::IMM8}, Cond::ALWAYS, 1}, &Cpu::SUB},
    (Instr){(Instr_args){"RST", 0xDF, (Operand){Addr_mode::IMPL_SHOW, NO_REG, 0x18}, (Operand){Addr_mode::IMPL}, Cond::ALWAYS, 1}, &Cpu::JP},
    (Instr){(Instr_args){"LD", 0xE0, (Operand){Addr_mode::HRAM_PLUS_IMM8}, (Operand){Addr_mode::REG, A}}, &Cpu::LD},
    (Instr){(Instr_args){"POP", 0xE1, (Operand){Addr_mode::REG16, HL}, (Operand){Addr_mode::MEM16_REG, SP}, Cond::ALWAYS, 1}, &Cpu::PUSH_POP},
    (Instr){(Instr_args){"LD", 0xE2, (Operand){Addr_mode::HRAM_PLUS_C}, (Operand){Addr_mode::REG, A}}, &Cpu::LD},
    (Instr){(Instr_args){"X_X", 0xE3}, &Cpu::X_X},
    (Instr){(Instr_args){"X_X", 0xE4}, &Cpu::X_X},
    (Instr){(Instr_args){"PUSH", 0xE5, (Operand){Addr_mode::MEM16_REG, SP}, (Operand){Addr_mode::REG16, HL}, Cond::ALWAYS, 0}, &Cpu::PUSH_POP},
    (Instr){(Instr_args){"AND", 0xE6, (Operand){Addr_mode::REG, A}, (Operand){Addr_mode::IMM8}}, &Cpu::AND},
    (Instr){(Instr_args){"RST", 0xE7, (Operand){Addr_mode::IMPL_SHOW, NO_REG, 0x20}, (Operand){Addr_mode::IMPL}, Cond::ALWAYS, 1}, &Cpu::JP},
    (Instr){(Instr_args){"ADD", 0xE8, (Operand){Addr_mode::REG16, SP}, (Operand){Addr_mode::IMMe8}}, &Cpu::ADD},
    (Instr){(Instr_args){"JP", 0xE9, (Operand){Addr_mode::REG16, HL}}, &Cpu::JP},
    (Instr){(Instr_args){"LD", 0xEA, (Operand){Addr_mode::MEM_IMM16}, (Operand){Addr_mode::REG, A}}, &Cpu::LD},
    (Instr){(Instr_args){"X_X", 0xEB}, &Cpu::X_X},
    (Instr){(Instr_args){"X_X", 0xEC}, &Cpu::X_X},
    (Instr){(Instr_args){"X_X", 0xED}, &Cpu::X_X},
    (Instr){(Instr_args){"XOR", 0xEE, (Operand){Addr_mode::REG, A}, (Operand){Addr_mode::IMM8}}, &Cpu::XOR},
    (Instr){(Instr_args){"RST", 0xEF, (Operand){Addr_mode::IMPL_SHOW, NO_REG, 0x28}, (Operand){Addr_mode::IMPL}, Cond::ALWAYS, 1}, &Cpu::JP},
    (Instr){(Instr_args){"LD", 0xF0, (Operand){Addr_mode::REG, A}, (Operand){Addr_mode::HRAM_PLUS_IMM8}}, &Cpu::LD},
    (Instr){(Instr_args){"POP", 0xF1, (Operand){Addr_mode::REG16, AF}, (Operand){Addr_mode::MEM16_REG, SP}, Cond::ALWAYS, 1}, &Cpu::PUSH_POP},
    (Instr){(Instr_args){"LD", 0xF2, (Operand){Addr_mode::REG, A}, (Operand){Addr_mode::HRAM_PLUS_C}}, &Cpu::LD},
    (Instr){(Instr_args){"DI", 0xF3}, &Cpu::DI},
    (Instr){(Instr_args){"X_X", 0xF4}, &Cpu::X_X},
    (Instr){(Instr_args){"PUSH", 0xF5, (Operand){Addr_mode::MEM16_REG, SP}, (Operand){Addr_mode::REG16, AF}, Cond::ALWAYS, 0}, &Cpu::PUSH_POP},
    (Instr){(Instr_args){"OR", 0xF6, (Operand){Addr_mode::REG, A}, (Operand){Addr_mode::IMM8}}, &Cpu::OR},
    (Instr){(Instr_args){"RST", 0xF7, (Operand){Addr_mode::IMPL_SHOW, NO_REG, 0x30}, (Operand){Addr_mode::IMPL}, Cond::ALWAYS, 1}, &Cpu::JP},
    (Instr){(Instr_args){"LD", 0xF8, (Operand){Addr_mode::REG16, HL}, (Operand){Addr_mode::REG16_PLUS_IMMe8, SP}}, &Cpu::LD},
    (Instr){(Instr_args){"LD", 0xF9, (Operand){Addr_mode::REG16, SP}, (Operand){Addr_mode::REG16, HL}}, &Cpu::LD},
    (Instr){(Instr_args){"LD", 0xFA, (Operand){Addr_mode::REG, A}, (Operand){Addr_mode::MEM_IMM16}}, &Cpu::LD},
    (Instr){(Instr_args){"EI", 0xFB}, &Cpu::EI},
    (Instr){(Instr_args){"X_X", 0xFC}, &Cpu::X_X},
    (Instr){(Instr_args){"X_X", 0xFD}, &Cpu::X_X},
    (Instr){(Instr_args){"CP", 0xFE, (Operand){Addr_mode::REG, A}, (Operand){Addr_mode::IMM8}}, &Cpu::CP},
...
// };
// Instr Cpu::instr_table_prefix_oldwtf[0x100] = {
//     (Instr){(Instr_args){"NOP",0x00}, &Cpu::NOP},
//     (Instr){(Instr_args){"LD", 0x01, (Operand){Addr_mode::REG16, BC}, (Operand){Addr_mode::IMM16}}, &Cpu::LD},
//     (Instr){(Instr_args){"LD", 0x02, (Operand){Addr_mode::MEM_REG, BC}, (Operand){Addr_mode::REG, A}}, &Cpu::LD},
//     (Instr){(Instr_args){"INC", 0x03, (Operand){Addr_mode::REG16, BC}, (Operand){Addr_mode::IMPL, NO_REG, 1}, Cond::ALWAYS, 2}, &Cpu::ADD},
...
Instr Cpu::instr_table_prefix[0x100] = {
    ...
    (Instr){(Instr_args){"RLC",0xCB03, (Operand){Addr_mode::REG, E}, (Operand){Addr_mode::IMPL}, Cond::ALWAYS, 3}, &Cpu::ROT},
    (Instr){(Instr_args){"RLC",0xCB04, (Operand){Addr_mode::REG, H}, (Operand){Addr_mode::IMPL}, Cond::ALWAYS, 3}, &Cpu::ROT},
    (Instr){(Instr_args){"RLC",0xCB05, (Operand){Addr_mode::REG, L}, (Operand){Addr_mode::IMPL}, Cond::ALWAYS, 3}, &Cpu::ROT},
    (Instr){(Instr_args){"RLC",0xCB06, (Operand){Addr_mode::MEM_REG, HL}, (Operand){Addr_mode::IMPL}, Cond::ALWAYS, 3}, &Cpu::ROT},
    (Instr){(Instr_args){"RLC",0xCB07, (Operand){Addr_mode::REG, A}, (Operand){Addr_mode::IMPL}, Cond::ALWAYS, 3}, &Cpu::ROT},
    (Instr){(Instr_args){"RRC",0xCB08, (Operand){Addr_mode::REG, B}, (Operand){Addr_mode::IMPL}, Cond::ALWAYS, 7}, &Cpu::ROT},
    (Instr){(Instr_args){"RRC",0xCB09, (Operand){Addr_mode::REG, C}, (Operand){Addr_mode::IMPL}, Cond::ALWAYS, 7}, &Cpu::ROT},
    (Instr){(Instr_args){"RRC",0xCB0A, (Operand){Addr_mode::REG, D}, (Operand){Addr_mode::IMPL}, Cond::ALWAYS, 7}, &Cpu::ROT},
    (Instr){(Instr_args){"RRC",0xCB0B, (Operand){Addr_mode::REG, E}, (Operand){Addr_mode::IMPL}, Cond::ALWAYS, 7}, &Cpu::ROT},
    (Instr){(Instr_args){"RRC",0xCB0C, (Operand){Addr_mode::REG, H}, (Operand){Addr_mode::IMPL}, Cond::ALWAYS, 7}, &Cpu::ROT},
    (Instr){(Instr_args){"RRC",0xCB0D, (Operand){Addr_mode::REG, L}, (Operand){Addr_mode::IMPL}, Cond::ALWAYS, 7}, &Cpu::ROT},
    (Instr){(Instr_args){"RRC",0xCB0E, (Operand){Addr_mode::MEM_REG, HL}, (Operand){Addr_mode::IMPL}, Cond::ALWAYS, 7}, &Cpu::ROT},
    (Instr){(Instr_args){"RRC",0xCB0F, (Operand){Addr_mode::REG, A}, (Operand){Addr_mode::IMPL}, Cond::ALWAYS, 7}, &Cpu::ROT},
    (Instr){(Instr_args){"RL",0xCB10, (Operand){Addr_mode::REG, B}, (Operand){Addr_mode::IMPL}, Cond::ALWAYS, 1}, &Cpu::ROT},
    (Instr){(Instr_args){"RL",0xCB11, (Operand){Addr_mode::REG, C}, (Operand){Addr_mode::IMPL}, Cond::ALWAYS, 1}, &Cpu::ROT},
    (Instr){(Instr_args){"RL",0xCB12, (Operand){Addr_mode::REG, D}, (Operand){Addr_mode::IMPL}, Cond::ALWAYS, 1}, &Cpu::ROT},
    (Instr){(Instr_args){"RL",0xCB13, (Operand){Addr_mode::REG, E}, (Operand){Addr_mode::IMPL}, Cond::ALWAYS, 1}, &Cpu::ROT},
    (Instr){(Instr_args){"RL",0xCB14, (Operand){Addr_mode::REG, H}, (Operand){Addr_mode::IMPL}, Cond::ALWAYS, 1}, &Cpu::ROT},
    (Instr){(Instr_args){"RL",0xCB15, (Operand){Addr_mode::REG, L}, (Operand){Addr_mode::IMPL}, Cond::ALWAYS, 1}, &Cpu::ROT},
    (Instr){(Instr_args){"RL",0xCB16, (Operand){Addr_mode::MEM_REG, HL}, (Operand){Addr_mode::IMPL}, Cond::ALWAYS, 1}, &Cpu::ROT},
    (Instr){(Instr_args){"RL",0xCB17, (Operand){Addr_mode::REG, A}, (Operand){Addr_mode::IMPL}, Cond::ALWAYS, 1}, &Cpu::ROT},
    (Instr){(Instr_args){"RR",0xCB18, (Operand){Addr_mode::REG, B}, (Operand){Addr_mode::IMPL}, Cond::ALWAYS, 5}, &Cpu::ROT},
    (Instr){(Instr_args){"RR",0xCB19, (Operand){Addr_mode::REG, C}, (Operand){Addr_mode::IMPL}, Cond::ALWAYS, 5}, &Cpu::ROT},
    (Instr){(Instr_args){"RR",0xCB1A, (Operand){Addr_mode::REG, D}, (Operand){Addr_mode::IMPL}, Cond::ALWAYS, 5}, &Cpu::ROT},
    (Instr){(Instr_args){"RR",0xCB1B, (Operand){Addr_mode::REG, E}, (Operand){Addr_mode::IMPL}, Cond::ALWAYS, 5}, &Cpu::ROT},
    (Instr){(Instr_args){"RR",0xCB1C, (Operand){Addr_mode::REG, H}, (Operand){Addr_mode::IMPL}, Cond::ALWAYS, 5}, &Cpu::ROT},
    (Instr){(Instr_args){"RR",0xCB1D, (Operand){Addr_mode::REG, L}, (Operand){Addr_mode::IMPL}, Cond::ALWAYS, 5}, &Cpu::ROT},
    (Instr){(Instr_args){"RR",0xCB1E, (Operand){Addr_mode::MEM_REG, HL}, (Operand){Addr_mode::IMPL}, Cond::ALWAYS, 5}, &Cpu::ROT},
    (Instr){(Instr_args){"RR",0xCB1F, (Operand){Addr_mode::REG, A}, (Operand){Addr_mode::IMPL}, Cond::ALWAYS, 5}, &Cpu::ROT},
    (Instr){(Instr_args){"SLA",0xCB20, (Operand){Addr_mode::REG, B}}, &Cpu::SHIFT},
    (Instr){(Instr_args){"SLA",0xCB21, (Operand){Addr_mode::REG, C}}, &Cpu::SHIFT},
    (Instr){(Instr_args){"SLA",0xCB22, (Operand){Addr_mode::REG, D}}, &Cpu::SHIFT},
    (Instr){(Instr_args){"SLA",0xCB23, (Operand){Addr_mode::REG, E}}, &Cpu::SHIFT},
    (Instr){(Instr_args){"SLA",0xCB24, (Operand){Addr_mode::REG, H}}, &Cpu::SHIFT},
    (Instr){(Instr_args){"SLA",0xCB25, (Operand){Addr_mode::REG, L}}, &Cpu::SHIFT},
    (Instr){(Instr_args){"SLA",0xCB26, (Operand){Addr_mode::MEM_REG, HL}}, &Cpu::SHIFT},
    (Instr){(Instr_args){"SLA",0xCB27, (Operand){Addr_mode::REG, A}}, &Cpu::SHIFT},
    (Instr){(Instr_args){"SRA",0xCB28, (Operand){Addr_mode::REG, B}, (Operand){Addr_mode::IMPL}, Cond::ALWAYS, 1}, &Cpu::SHIFT},
    (Instr){(Instr_args){"SRA",0xCB29, (Operand){Addr_mode::REG, C}, (Operand){Addr_mode::IMPL}, Cond::ALWAYS, 1}, &Cpu::SHIFT},
    (Instr){(Instr_args){"SRA",0xCB2A, (Operand){Addr_mode::REG, D}, (Operand){Addr_mode::IMPL}, Cond::ALWAYS, 1}, &Cpu::SHIFT},
    (Instr){(Instr_args){"SRA",0xCB2B, (Operand){Addr_mode::REG, E}, (Operand){Addr_mode::IMPL}, Cond::ALWAYS, 1}, &Cpu::SHIFT},
    (Instr){(Instr_args){"SRA",0xCB2C, (Operand){Addr_mode::REG, H}, (Operand){Addr_mode::IMPL}, Cond::ALWAYS, 1}, &Cpu::SHIFT},
    (Instr){(Instr_args){"SRA",0xCB2D, (Operand){Addr_mode::REG, L}, (Operand){Addr_mode::IMPL}, Cond::ALWAYS, 1}, &Cpu::SHIFT},
    (Instr){(Instr_args){"SRA",0xCB2E, (Operand){Addr_mode::MEM_REG, HL}, (Operand){Addr_mode::IMPL}, Cond::ALWAYS, 1}, &Cpu::SHIFT},
    (Instr){(Instr_args){"SRA",0xCB2F, (Operand){Addr_mode::REG, A}, (Operand){Addr_mode::IMPL}, Cond::ALWAYS, 1}, &Cpu::SHIFT},
    (Instr){(Instr_args){"SWAP",0xCB30, (Operand){Addr_mode::REG, B}}, &Cpu::SWAP},
    (Instr){(Instr_args){"SWAP",0xCB31, (Operand){Addr_mode::REG, C}}, &Cpu::SWAP},
    (Instr){(Instr_args){"SWAP",0xCB32, (Operand){Addr_mode::REG, D}}, &Cpu::SWAP},
    (Instr){(Instr_args){"SWAP",0xCB33, (Operand){Addr_mode::REG, E}}, &Cpu::SWAP},
    (Instr){(Instr_args){"SWAP",0xCB34, (Operand){Addr_mode::REG, H}}, &Cpu::SWAP},
    (Instr){(Instr_args){"SWAP",0xCB35, (Operand){Addr_mode::REG, L}}, &Cpu::SWAP},
    (Instr){(Instr_args){"SWAP",0xCB36, (Operand){Addr_mode::MEM_REG, HL}}, &Cpu::SWAP},
    (Instr){(Instr_args){"SWAP",0xCB37, (Operand){Addr_mode::REG, A}}, &Cpu::SWAP},
    (Instr){(Instr_args){"SRL",0xCB38, (Operand){Addr_mode::REG, B}, (Operand){Addr_mode::IMPL}, Cond::ALWAYS, 2}, &Cpu::SHIFT},
    (Instr){(Instr_args){"SRL",0xCB39, (Operand){Addr_mode::REG, C}, (Operand){Addr_mode::IMPL}, Cond::ALWAYS, 2}, &Cpu::SHIFT},
    (Instr){(Instr_args){"SRL",0xCB3A, (Operand){Addr_mode::REG, D}, (Operand){Addr_mode::IMPL}, Cond::ALWAYS, 2}, &Cpu::SHIFT},
    (Instr){(Instr_args){"SRL",0xCB3B, (Operand){Addr_mode::REG, E}, (Operand){Addr_mode::IMPL}, Cond::ALWAYS, 2}, &Cpu::SHIFT},
    (Instr){(Instr_args){"SRL",0xCB3C, (Operand){Addr_mode::REG, H}, (Operand){Addr_mode::IMPL}, Cond::ALWAYS, 2}, &Cpu::SHIFT},
    (Instr){(Instr_args){"SRL",0xCB3D, (Operand){Addr_mode::REG, L}, (Operand){Addr_mode::IMPL}, Cond::ALWAYS, 2}, &Cpu::SHIFT},
    (Instr){(Instr_args){"SRL",0xCB3E, (Operand){Addr_mode::MEM_REG, HL}, (Operand){Addr_mode::IMPL}, Cond::ALWAYS, 2}, &Cpu::SHIFT},
    (Instr){(Instr_args){"SRL",0xCB3F, (Operand){Addr_mode::REG, A}, (Operand){Addr_mode::IMPL}, Cond::ALWAYS, 2}, &Cpu::SHIFT},
    (Instr){(Instr_args){"BIT",0xCB40, (Operand){Addr_mode::REG, B}, (Operand){Addr_mode::IMPL_SHOW, NO_REG, 0}}, &Cpu::BIT_INSTR},
    (Instr){(Instr_args){"BIT",0xCB41, (Operand){Addr_mode::REG, C}, (Operand){Addr_mode::IMPL_SHOW, NO_REG, 0}}, &Cpu::BIT_INSTR},
    (Instr){(Instr_args){"BIT",0xCB42, (Operand){Addr_mode::REG, D}, (Operand){Addr_mode::IMPL_SHOW, NO_REG, 0}}, &Cpu::BIT_INSTR},
    (Instr){(Instr_args){"BIT",0xCB43, (Operand){Addr_mode::REG, E}, (Operand){Addr_mode::IMPL_SHOW, NO_REG, 0}}, &Cpu::BIT_INSTR},
    (Instr){(Instr_args){"BIT",0xCB44, (Operand){Addr_mode::REG, H}, (Operand){Addr_mode::IMPL_SHOW, NO_REG, 0}}, &Cpu::BIT_INSTR},
    (Instr){(Instr_args){"BIT",0xCB45, (Operand){Addr_mode::REG, L}, (Operand){Addr_mode::IMPL_SHOW, NO_REG, 0}}, &Cpu::BIT_INSTR},
    (Instr){(Instr_args){"BIT",0xCB46, (Operand){Addr_mode::MEM_REG, HL}, (Operand){Addr_mode::IMPL_SHOW, NO_REG, 0}}, &Cpu::BIT_INSTR},
    (Instr){(Instr_args){"BIT",0xCB47, (Operand){Addr_mode::REG, A}, (Operand){Addr_mode::IMPL_SHOW, NO_REG, 0}}, &Cpu::BIT_INSTR},
    (Instr){(Instr_args){"BIT",0xCB48, (Operand){Addr_mode::REG, B}, (Operand){Addr_mode::IMPL_SHOW, NO_REG, 1}}, &Cpu::BIT_INSTR},
    (Instr){(Instr_args){"BIT",0xCB49, (Operand){Addr_mode::REG, C}, (Operand){Addr_mode::IMPL_SHOW, NO_REG, 1}}, &Cpu::BIT_INSTR},
    (Instr){(Instr_args){"BIT",0xCB4A, (Operand){Addr_mode::REG, D}, (Operand){Addr_mode::IMPL_SHOW, NO_REG, 1}}, &Cpu::BIT_INSTR},
    (Instr){(Instr_args){"BIT",0xCB4B, (Operand){Addr_mode::REG, E}, (Operand){Addr_mode::IMPL_SHOW, NO_REG, 1}}, &Cpu::BIT_INSTR},
    (Instr){(Instr_args){"BIT",0xCB4C, (Operand){Addr_mode::REG, H}, (Operand){Addr_mode::IMPL_SHOW, NO_REG, 1}}, &Cpu::BIT_INSTR},
    (Instr){(Instr_args){"BIT",0xCB4D, (Operand){Addr_mode::REG, L}, (Operand){Addr_mode::IMPL_SHOW, NO_REG, 1}}, &Cpu::BIT_INSTR},
    (Instr){(Instr_args){"BIT",0xCB4E, (Operand){Addr_mode::MEM_REG, HL}, (Operand){Addr_mode::IMPL_SHOW, NO_REG, 1}}, &Cpu::BIT_INSTR},
    (Instr){(Instr_args){"BIT",0xCB4F, (Operand){Addr_mode::REG, A}, (Operand){Addr_mode::IMPL_SHOW, NO_REG, 1}}, &Cpu::BIT_INSTR},
    (Instr){(Instr_args){"BIT",0xCB50, (Operand){Addr_mode::REG, B}, (Operand){Addr_mode::IMPL_SHOW, NO_REG, 2}}, &Cpu::BIT_INSTR},
    (Instr){(Instr_args){"BIT",0xCB51, (Operand){Addr_mode::REG, C}, (Operand){Addr_mode::IMPL_SHOW, NO_REG, 2}}, &Cpu::BIT_INSTR},
    (Instr){(Instr_args){"BIT",0xCB52, (Operand){Addr_mode::REG, D}, (Operand){Addr_mode::IMPL_SHOW, NO_REG, 2}}, &Cpu::BIT_INSTR},
    (Instr){(Instr_args){"BIT",0xCB53, (Operand){Addr_mode::REG, E}, (Operand){Addr_mode::IMPL_SHOW, NO_REG, 2}}, &Cpu::BIT_INSTR},
    (Instr){(Instr_args){"BIT",0xCB54, (Operand){Addr_mode::REG, H}, (Operand){Addr_mode::IMPL_SHOW, NO_REG, 2}}, &Cpu::BIT_INSTR},
    (Instr){(Instr_args){"BIT",0xCB55, (Operand){Addr_mode::REG, L}, (Operand){Addr_mode::IMPL_SHOW, NO_REG, 2}}, &Cpu::BIT_INSTR},
    (Instr){(Instr_args){"BIT",0xCB56, (Operand){Addr_mode::MEM_REG, HL}, (Operand){Addr_mode::IMPL_SHOW, NO_REG, 2}}, &Cpu::BIT_INSTR},
    (Instr){(Instr_args){"BIT",0xCB57, (Operand){Addr_mode::REG, A}, (Operand){Addr_mode::IMPL_SHOW, NO_REG, 2}}, &Cpu::BIT_INSTR},
    (Instr){(Instr_args){"BIT",0xCB58, (Operand){Addr_mode::REG, B}, (Operand){Addr_mode::IMPL_SHOW, NO_REG, 3}}, &Cpu::BIT_INSTR},
    (Instr){(Instr_args){"BIT",0xCB59, (Operand){Addr_mode::REG, C}, (Operand){Addr_mode::IMPL_SHOW, NO_REG, 3}}, &Cpu::BIT_INSTR},
    (Instr){(Instr_args){"BIT",0xCB5A, (Operand){Addr_mode::REG, D}, (Operand){Addr_mode::IMPL_SHOW, NO_REG, 3}}, &Cpu::BIT_INSTR},
    (Instr){(Instr_args){"BIT",0xCB5B, (Operand){Addr_mode::REG, E}, (Operand){Addr_mode::IMPL_SHOW, NO_REG, 3}}, &Cpu::BIT_INSTR},
    (Instr){(Instr_args){"BIT",0xCB5C, (Operand){Addr_mode::REG, H}, (Operand){Addr_mode::IMPL_SHOW, NO_REG, 3}}, &Cpu::BIT_INSTR},
    (Instr){(Instr_args){"BIT",0xCB5D, (Operand){Addr_mode::REG, L}, (Operand){Addr_mode::IMPL_SHOW, NO_REG, 3}}, &Cpu::BIT_INSTR},
    (Instr){(Instr_args){"BIT",0xCB5E, (Operand){Addr_mode::MEM_REG, HL}, (Operand){Addr_mode::IMPL_SHOW, NO_REG, 3}}, &Cpu::BIT_INSTR},
    (Instr){(Instr_args){"BIT",0xCB5F, (Operand){Addr_mode::REG, A}, (Operand){Addr_mode::IMPL_SHOW, NO_REG, 3}}, &Cpu::BIT_INSTR},
    (Instr){(Instr_args){"BIT",0xCB60, (Operand){Addr_mode::REG, B}, (Operand){Addr_mode::IMPL_SHOW, NO_REG, 4}}, &Cpu::BIT_INSTR},
    (Instr){(Instr_args){"BIT",0xCB61, (Operand){Addr_mode::REG, C}, (Operand){Addr_mode::IMPL_SHOW, NO_REG, 4}}, &Cpu::BIT_INSTR},
    (Instr){(Instr_args){"BIT",0xCB62, (Operand){Addr_mode::REG, D}, (Operand){Addr_mode::IMPL_SHOW, NO_REG, 4}}, &Cpu::BIT_INSTR},
    (Instr){(Instr_args){"BIT",0xCB63, (Operand){Addr_mode::REG, E}, (Operand){Addr_mode::IMPL_SHOW, NO_REG, 4}}, &Cpu::BIT_INSTR},
    (Instr){(Instr_args){"BIT",0xCB64, (Operand){Addr_mode::REG, H}, (Operand){Addr_mode::IMPL_SHOW, NO_REG, 4}}, &Cpu::BIT_INSTR},
    (Instr){(Instr_args){"BIT",0xCB65, (Operand){Addr_mode::REG, L}, (Operand){Addr_mode::IMPL_SHOW, NO_REG, 4}}, &Cpu::BIT_INSTR},
    (Instr){(Instr_args){"BIT",0xCB66, (Operand){Addr_mode::MEM_REG, HL}, (Operand){Addr_mode::IMPL_SHOW, NO_REG, 4}}, &Cpu::BIT_INSTR},
    (Instr){(Instr_args){"BIT",0xCB67, (Operand){Addr_mode::REG, A}, (Operand){Addr_mode::IMPL_SHOW, NO_REG, 4}}, &Cpu::BIT_INSTR},
    (Instr){(Instr_args){"BIT",0xCB68, (Operand){Addr_mode::REG, B}, (Operand){Addr_mode::IMPL_SHOW, NO_REG, 5}}, &Cpu::BIT_INSTR},
    (Instr){(Instr_args){"BIT",0xCB69, (Operand){Addr_mode::REG, C}, (Operand){Addr_mode::IMPL_SHOW, NO_REG, 5}}, &Cpu::BIT_INSTR},
    (Instr){(Instr_args){"BIT",0xCB6A, (Operand){Addr_mode::REG, D}, (Operand){Addr_mode::IMPL_SHOW, NO_REG, 5}}, &Cpu::BIT_INSTR},
    (Instr){(Instr_args){"BIT",0xCB6B, (Operand){Addr_mode::REG, E}, (Operand){Addr_mode::IMPL_SHOW, NO_REG, 5}}, &Cpu::BIT_INSTR},
    (Instr){(Instr_args){"BIT",0xCB6C, (Operand){Addr_mode::REG, H}, (Operand){Addr_mode::IMPL_SHOW, NO_REG, 5}}, &Cpu::BIT_INSTR},
    (Instr){(Instr_args){"BIT",0xCB6D, (Operand){Addr_mode::REG, L}, (Operand){Addr_mode::IMPL_SHOW, NO_REG, 5}}, &Cpu::BIT_INSTR},
    (Instr){(Instr_args){"BIT",0xCB6E, (Operand){Addr_mode::MEM_REG, HL}, (Operand){Addr_mode::IMPL_SHOW, NO_REG, 5}}, &Cpu::BIT_INSTR},
    (Instr){(Instr_args){"BIT",0xCB6F, (Operand){Addr_mode::REG, A}, (Operand){Addr_mode::IMPL_SHOW, NO_REG, 5}}, &Cpu::BIT_INSTR},
    (Instr){(Instr_args){"BIT",0xCB70, (Operand){Addr_mode::REG, B}, (Operand){Addr_mode::IMPL_SHOW, NO_REG, 6}}, &Cpu::BIT_INSTR},
    (Instr){(Instr_args){"BIT",0xCB71, (Operand){Addr_mode::REG, C}, (Operand){Addr_mode::IMPL_SHOW, NO_REG, 6}}, &Cpu::BIT_INSTR},
    (Instr){(Instr_args){"BIT",0xCB72, (Operand){Addr_mode::REG, D}, (Operand){Addr_mode::IMPL_SHOW, NO_REG, 6}}, &Cpu::BIT_INSTR},
    (Instr){(Instr_args){"BIT",0xCB73, (Operand){Addr_mode::REG, E}, (Operand){Addr_mode::IMPL_SHOW, NO_REG, 6}}, &Cpu::BIT_INSTR},
    (Instr){(Instr_args){"BIT",0xCB74, (Operand){Addr_mode::REG, H}, (Operand){Addr_mode::IMPL_SHOW, NO_REG, 6}}, &Cpu::BIT_INSTR},
    (Instr){(Instr_args){"BIT",0xCB75, (Operand){Addr_mode::REG, L}, (Operand){Addr_mode::IMPL_SHOW, NO_REG, 6}}, &Cpu::BIT_INSTR},
    (Instr){(Instr_args){"BIT",0xCB76, (Operand){Addr_mode::MEM_REG, HL}, (Operand){Addr_mode::IMPL_SHOW, NO_REG, 6}}, &Cpu::BIT_INSTR},
    (Instr){(Instr_args){"BIT",0xCB77, (Operand){Addr_mode::REG, A}, (Operand){Addr_mode::IMPL_SHOW, NO_REG, 6}}, &Cpu::BIT_INSTR},
    (Instr){(Instr_args){"BIT",0xCB78, (Operand){Addr_mode::REG, B}, (Operand){Addr_mode::IMPL_SHOW, NO_REG, 7}}, &Cpu::BIT_INSTR},
    (Instr){(Instr_args){"BIT",0xCB79, (Operand){Addr_mode::REG, C}, (Operand){Addr_mode::IMPL_SHOW, NO_REG, 7}}, &Cpu::BIT_INSTR},
    (Instr){(Instr_args){"BIT",0xCB7A, (Operand){Addr_mode::REG, D}, (Operand){Addr_mode::IMPL_SHOW, NO_REG, 7}}, &Cpu::BIT_INSTR},
    (Instr){(Instr_args){"BIT",0xCB7B, (Operand){Addr_mode::REG, E}, (Operand){Addr_mode::IMPL_SHOW, NO_REG, 7}}, &Cpu::BIT_INSTR},
    (Instr){(Instr_args){"BIT",0xCB7C, (Operand){Addr_mode::REG, H}, (Operand){Addr_mode::IMPL_SHOW, NO_REG, 7}}, &Cpu::BIT_INSTR},
    (Instr){(Instr_args){"BIT",0xCB7D, (Operand){Addr_mode::REG, L}, (Operand){Addr_mode::IMPL_SHOW, NO_REG, 7}}, &Cpu::BIT_INSTR},
    (Instr){(Instr_args){"BIT",0xCB7E, (Operand){Addr_mode::MEM_REG, HL}, (Operand){Addr_mode::IMPL_SHOW, NO_REG, 7}}, &Cpu::BIT_INSTR},
    (Instr){(Instr_args){"BIT",0xCB7F, (Operand){Addr_mode::REG, A}, (Operand){Addr_mode::IMPL_SHOW, NO_REG, 7}}, &Cpu::BIT_INSTR},
    (Instr){(Instr_args){"RES",0xCB80, (Operand){Addr_mode::REG, B}, (Operand){Addr_mode::IMPL_SHOW, NO_REG, 0}}, &Cpu::RES},
    (Instr){(Instr_args){"RES",0xCB81, (Operand){Addr_mode::REG, C}, (Operand){Addr_mode::IMPL_SHOW, NO_REG, 0}}, &Cpu::RES},
    (Instr){(Instr_args){"RES",0xCB82, (Operand){Addr_mode::REG, D}, (Operand){Addr_mode::IMPL_SHOW, NO_REG, 0}}, &Cpu::RES},
    (Instr){(Instr_args){"RES",0xCB83, (Operand){Addr_mode::REG, E}, (Operand){Addr_mode::IMPL_SHOW, NO_REG, 0}}, &Cpu::RES},
    (Instr){(Instr_args){"RES",0xCB84, (Operand){Addr_mode::REG, H}, (Operand){Addr_mode::IMPL_SHOW, NO_REG, 0}}, &Cpu::RES},
    (Instr){(Instr_args){"RES",0xCB85, (Operand){Addr_mode::REG, L}, (Operand){Addr_mode::IMPL_SHOW, NO_REG, 0}}, &Cpu::RES},
    (Instr){(Instr_args){"RES",0xCB86, (Operand){Addr_mode::MEM_REG, HL}, (Operand){Addr_mode::IMPL_SHOW, NO_REG, 0}}, &Cpu::RES},
    (Instr){(Instr_args){"RES",0xCB87, (Operand){Addr_mode::REG, A}, (Operand){Addr_mode::IMPL_SHOW, NO_REG, 0}}, &Cpu::RES},
    (Instr){(Instr_args){"RES",0xCB88, (Operand){Addr_mode::REG, B}, (Operand){Addr_mode::IMPL_SHOW, NO_REG, 1}}, &Cpu::RES},
    (Instr){(Instr_args){"RES",0xCB89, (Operand){Addr_mode::REG, C}, (Operand){Addr_mode::IMPL_SHOW, NO_REG, 1}}, &Cpu::RES},
    (Instr){(Instr_args){"RES",0xCB8A, (Operand){Addr_mode::REG, D}, (Operand){Addr_mode::IMPL_SHOW, NO_REG, 1}}, &Cpu::RES},
    (Instr){(Instr_args){"RES",0xCB8B, (Operand){Addr_mode::REG, E}, (Operand){Addr_mode::IMPL_SHOW, NO_REG, 1}}, &Cpu::RES},
    (Instr){(Instr_args){"RES",0xCB8C, (Operand){Addr_mode::REG, H}, (Operand){Addr_mode::IMPL_SHOW, NO_REG, 1}}, &Cpu::RES},
    (Instr){(Instr_args){"RES",0xCB8D, (Operand){Addr_mode::REG, L}, (Operand){Addr_mode::IMPL_SHOW, NO_REG, 1}}, &Cpu::RES},
    (Instr){(Instr_args){"RES",0xCB8E, (Operand){Addr_mode::MEM_REG, HL}, (Operand){Addr_mode::IMPL_SHOW, NO_REG, 1}}, &Cpu::RES},
    (Instr){(Instr_args){"RES",0xCB8F, (Operand){Addr_mode::REG, A}, (Operand){Addr_mode::IMPL_SHOW, NO_REG, 1}}, &Cpu::RES},
    (Instr){(Instr_args){"RES",0xCB90, (Operand){Addr_mode::REG, B}, (Operand){Addr_mode::IMPL_SHOW, NO_REG, 2}}, &Cpu::RES},
    (Instr){(Instr_args){"RES",0xCB91, (Operand){Addr_mode::REG, C}, (Operand){Addr_mode::IMPL_SHOW, NO_REG, 2}}, &Cpu::RES},
    (Instr){(Instr_args){"RES",0xCB92, (Operand){Addr_mode::REG, D}, (Operand){Addr_mode::IMPL_SHOW, NO_REG, 2}}, &Cpu::RES},
    (Instr){(Instr_args){"RES",0xCB93, (Operand){Addr_mode::REG, E}, (Operand){Addr_mode::IMPL_SHOW, NO_REG, 2}}, &Cpu::RES},
    (Instr){(Instr_args){"RES",0xCB94, (Operand){Addr_mode::REG, H}, (Operand){Addr_mode::IMPL_SHOW, NO_REG, 2}}, &Cpu::RES},
    (Instr){(Instr_args){"RES",0xCB95, (Operand){Addr_mode::REG, L}, (Operand){Addr_mode::IMPL_SHOW, NO_REG, 2}}, &Cpu::RES},
    (Instr){(Instr_args){"RES",0xCB96, (Operand){Addr_mode::MEM_REG, HL}, (Operand){Addr_mode::IMPL_SHOW, NO_REG, 2}}, &Cpu::RES},
    (Instr){(Instr_args){"RES",0xCB97, (Operand){Addr_mode::REG, A}, (Operand){Addr_mode::IMPL_SHOW, NO_REG, 2}}, &Cpu::RES},
    (Instr){(Instr_args){"RES",0xCB98, (Operand){Addr_mode::REG, B}, (Operand){Addr_mode::IMPL_SHOW, NO_REG, 3}}, &Cpu::RES},
    (Instr){(Instr_args){"RES",0xCB99, (Operand){Addr_mode::REG, C}, (Operand){Addr_mode::IMPL_SHOW, NO_REG, 3}}, &Cpu::RES},
    (Instr){(Instr_args){"RES",0xCB9A, (Operand){Addr_mode::REG, D}, (Operand){Addr_mode::IMPL_SHOW, NO_REG, 3}}, &Cpu::RES},
    (Instr){(Instr_args){"RES",0xCB9B, (Operand){Addr_mode::REG, E}, (Operand){Addr_mode::IMPL_SHOW, NO_REG, 3}}, &Cpu::RES},
    (Instr){(Instr_args){"RES",0xCB9C, (Operand){Addr_mode::REG, H}, (Operand){Addr_mode::IMPL_SHOW, NO_REG, 3}}, &Cpu::RES},
    (Instr){(Instr_args){"RES",0xCB9D, (Operand){Addr_mode::REG, L}, (Operand){Addr_mode::IMPL_SHOW, NO_REG, 3}}, &Cpu::RES},
    (Instr){(Instr_args){"RES",0xCB9E, (Operand){Addr_mode::MEM_REG, HL}, (Operand){Addr_mode::IMPL_SHOW, NO_REG, 3}}, &Cpu::RES},
    (Instr){(Instr_args){"RES",0xCB9F, (Operand){Addr_mode::REG, A}, (Operand){Addr_mode::IMPL_SHOW, NO_REG, 3}}, &Cpu::RES},
    (Instr){(Instr_args){"RES",0xCBA0, (Operand){Addr_mode::REG, B}, (Operand){Addr_mode::IMPL_SHOW, NO_REG, 4}}, &Cpu::RES},
    (Instr){(Instr_args){"RES",0xCBA1, (Operand){Addr_mode::REG, C}, (Operand){Addr_mode::IMPL_SHOW, NO_REG, 4}}, &Cpu::RES},
    (Instr){(Instr_args){"RES",0xCBA2, (Operand){Addr_mode::REG, D}, (Operand){Addr_mode::IMPL_SHOW, NO_REG, 4}}, &Cpu::RES},
    (Instr){(Instr_args){"RES",0xCBA3, (Operand){Addr_mode::REG, E}, (Operand){Addr_mode::IMPL_SHOW, NO_REG, 4}}, &Cpu::RES},
    (Instr){(Instr_args){"RES",0xCBA4, (Operand){Addr_mode::REG, H}, (Operand){Addr_mode::IMPL_SHOW, NO_REG, 4}}, &Cpu::RES},
    (Instr){(Instr_args){"RES",0xCBA5, (Operand){Addr_mode::REG, L}, (Operand){Addr_mode::IMPL_SHOW, NO_REG, 4}}, &Cpu::RES},
    (Instr){(Instr_args){"RES",0xCBA6, (Operand){Addr_mode::MEM_REG, HL}, (Operand){Addr_mode::IMPL_SHOW, NO_REG, 4}}, &Cpu::RES},
    (Instr){(Instr_args){"RES",0xCBA7, (Operand){Addr_mode::REG, A}, (Operand){Addr_mode::IMPL_SHOW, NO_REG, 4}}, &Cpu::RES},
    (Instr){(Instr_args){"RES",0xCBA8, (Operand){Addr_mode::REG, B}, (Operand){Addr_mode::IMPL_SHOW, NO_REG, 5}}, &Cpu::RES},
    (Instr){(Instr_args){"RES",0xCBA9, (Operand){Addr_mode::REG, C}, (Operand){Addr_mode::IMPL_SHOW, NO_REG, 5}}, &Cpu::RES},
    (Instr){(Instr_args){"RES",0xCBAA, (Operand){Addr_mode::REG, D}, (Operand){Addr_mode::IMPL_SHOW, NO_REG, 5}}, &Cpu::RES},
    (Instr){(Instr_args){"RES",0xCBAB, (Operand){Addr_mode::REG, E}, (Operand){Addr_mode::IMPL_SHOW, NO_REG, 5}}, &Cpu::RES},
    (Instr){(Instr_args){"RES",0xCBAC, (Operand){Addr_mode::REG, H}, (Operand){Addr_mode::IMPL_SHOW, NO_REG, 5}}, &Cpu::RES},
    (Instr){(Instr_args){"RES",0xCBAD, (Operand){Addr_mode::REG, L}, (Operand){Addr_mode::IMPL_SHOW, NO_REG, 5}}, &Cpu::RES},
    (Instr){(Instr_args){"RES",0xCBAE, (Operand){Addr_mode::MEM_REG, HL}, (Operand){Addr_mode::IMPL_SHOW, NO_REG, 5}}, &Cpu::RES},
    (Instr){(Instr_args){"RES",0xCBAF, (Operand){Addr_mode::REG, A}, (Operand){Addr_mode::IMPL_SHOW, NO_REG, 5}}, &Cpu::RES},
    (Instr){(Instr_args){"RES",0xCBB0, (Operand){Addr_mode::REG, B}, (Operand){Addr_mode::IMPL_SHOW, NO_REG, 6}}, &Cpu::RES},
    (Instr){(Instr_args){"RES",0xCBB1, (Operand){Addr_mode::REG, C}, (Operand){Addr_mode::IMPL_SHOW, NO_REG, 6}}, &Cpu::RES},
    (Instr){(Instr_args){"RES",0xCBB2, (Operand){Addr_mode::REG, D}, (Operand){Addr_mode::IMPL_SHOW, NO_REG, 6}}, &Cpu::RES},
    (Instr){(Instr_args){"RES",0xCBB3, (Operand){Addr_mode::REG, E}, (Operand){Addr_mode::IMPL_SHOW, NO_REG, 6}}, &Cpu::RES},
    (Instr){(Instr_args){"RES",0xCBB4, (Operand){Addr_mode::REG, H}, (Operand){Addr_mode::IMPL_SHOW, NO_REG, 6}}, &Cpu::RES},
    (Instr){(Instr_args){"RES",0xCBB5, (Operand){Addr_mode::REG, L}, (Operand){Addr_mode::IMPL_SHOW, NO_REG, 6}}, &Cpu::RES},
    (Instr){(Instr_args){"RES",0xCBB6, (Operand){Addr_mode::MEM_REG, HL}, (Operand){Addr_mode::IMPL_SHOW, NO_REG, 6}}, &Cpu::RES},
    (Instr){(Instr_args){"RES",0xCBB7, (Operand){Addr_mode::REG, A}, (Operand){Addr_mode::IMPL_SHOW, NO_REG, 6}}, &Cpu::RES},
    (Instr){(Instr_args){"RES",0xCBB8, (Operand){Addr_mode::REG, B}, (Operand){Addr_mode::IMPL_SHOW, NO_REG, 7}}, &Cpu::RES},
    (Instr){(Instr_args){"RES",0xCBB9, (Operand){Addr_mode::REG, C}, (Operand){Addr_mode::IMPL_SHOW, NO_REG, 7}}, &Cpu::RES},
    (Instr){(Instr_args){"RES",0xCBBA, (Operand){Addr_mode::REG, D}, (Operand){Addr_mode::IMPL_SHOW, NO_REG, 7}}, &Cpu::RES},
    (Instr){(Instr_args){"RES",0xCBBB, (Operand){Addr_mode::REG, E}, (Operand){Addr_mode::IMPL_SHOW, NO_REG, 7}}, &Cpu::RES},
    (Instr){(Instr_args){"RES",0xCBBC, (Operand){Addr_mode::REG, H}, (Operand){Addr_mode::IMPL_SHOW, NO_REG, 7}}, &Cpu::RES},
    (Instr){(Instr_args){"RES",0xCBBD, (Operand){Addr_mode::REG, L}, (Operand){Addr_mode::IMPL_SHOW, NO_REG, 7}}, &Cpu::RES},
    (Instr){(Instr_args){"RES",0xCBBE, (Operand){Addr_mode::MEM_REG, HL}, (Operand){Addr_mode::IMPL_SHOW, NO_REG, 7}}, &Cpu::RES},
    (Instr){(Instr_args){"RES",0xCBBF, (Operand){Addr_mode::REG, A}, (Operand){Addr_mode::IMPL_SHOW, NO_REG, 7}}, &Cpu::RES},
    (Instr){(Instr_args){"SET",0xCBC0, (Operand){Addr_mode::REG, B}, (Operand){Addr_mode::IMPL_SHOW, NO_REG, 0}}, &Cpu::SET},
    (Instr){(Instr_args){"SET",0xCBC1, (Operand){Addr_mode::REG, C}, (Operand){Addr_mode::IMPL_SHOW, NO_REG, 0}}, &Cpu::SET},
    (Instr){(Instr_args){"SET",0xCBC2, (Operand){Addr_mode::REG, D}, (Operand){Addr_mode::IMPL_SHOW, NO_REG, 0}}, &Cpu::SET},
    (Instr){(Instr_args){"SET",0xCBC3, (Operand){Addr_mode::REG, E}, (Operand){Addr_mode::IMPL_SHOW, NO_REG, 0}}, &Cpu::SET},
    (Instr){(Instr_args){"SET",0xCBC4, (Operand){Addr_mode::REG, H}, (Operand){Addr_mode::IMPL_SHOW, NO_REG, 0}}, &Cpu::SET},
    (Instr){(Instr_args){"SET",0xCBC5, (Operand){Addr_mode::REG, L}, (Operand){Addr_mode::IMPL_SHOW, NO_REG, 0}}, &Cpu::SET},
    (Instr){(Instr_args){"SET",0xCBC6, (Operand){Addr_mode::MEM_REG, HL}, (Operand){Addr_mode::IMPL_SHOW, NO_REG, 0}}, &Cpu::SET},
    (Instr){(Instr_args){"SET",0xCBC7, (Operand){Addr_mode::REG, A}, (Operand){Addr_mode::IMPL_SHOW, NO_REG, 0}}, &Cpu::SET},
    (Instr){(Instr_args){"SET",0xCBC8, (Operand){Addr_mode::REG, B}, (Operand){Addr_mode::IMPL_SHOW, NO_REG, 1}}, &Cpu::SET},
    (Instr){(Instr_args){"SET",0xCBC9, (Operand){Addr_mode::REG, C}, (Operand){Addr_mode::IMPL_SHOW, NO_REG, 1}}, &Cpu::SET},
    (Instr){(Instr_args){"SET",0xCBCA, (Operand){Addr_mode::REG, D}, (Operand){Addr_mode::IMPL_SHOW, NO_REG, 1}}, &Cpu::SET},
    (Instr){(Instr_args){"SET",0xCBCB, (Operand){Addr_mode::REG, E}, (Operand){Addr_mode::IMPL_SHOW, NO_REG, 1}}, &Cpu::SET},
    (Instr){(Instr_args){"SET",0xCBCC, (Operand){Addr_mode::REG, H}, (Operand){Addr_mode::IMPL_SHOW, NO_REG, 1}}, &Cpu::SET},
    (Instr){(Instr_args){"SET",0xCBCD, (Operand){Addr_mode::REG, L}, (Operand){Addr_mode::IMPL_SHOW, NO_REG, 1}}, &Cpu::SET},
    (Instr){(Instr_args){"SET",0xCBCE, (Operand){Addr_mode::MEM_REG, HL}, (Operand){Addr_mode::IMPL_SHOW, NO_REG, 1}}, &Cpu::SET},
    (Instr){(Instr_args){"SET",0xCBCF, (Operand){Addr_mode::REG, A}, (Operand){Addr_mode::IMPL_SHOW, NO_REG, 1}}, &Cpu::SET},
    (Instr){(Instr_args){"SET",0xCBD0, (Operand){Addr_mode::REG, B}, (Operand){Addr_mode::IMPL_SHOW, NO_REG, 2}}, &Cpu::SET},
    (Instr){(Instr_args){"SET",0xCBD1, (Operand){Addr_mode::REG, C}, (Operand){Addr_mode::IMPL_SHOW, NO_REG, 2}}, &Cpu::SET},
    (Instr){(Instr_args){"SET",0xCBD2, (Operand){Addr_mode::REG, D}, (Operand){Addr_mode::IMPL_SHOW, NO_REG, 2}}, &Cpu::SET},
    (Instr){(Instr_args){"SET",0xCBD3, (Operand){Addr_mode::REG, E}, (Operand){Addr_mode::IMPL_SHOW, NO_REG, 2}}, &Cpu::SET},
    (Instr){(Instr_args){"SET",0xCBD4, (Operand){Addr_mode::REG, H}, (Operand){Addr_mode::IMPL_SHOW, NO_REG, 2}}, &Cpu::SET},
    (Instr){(Instr_args){"SET",0xCBD5, (Operand){Addr_mode::REG, L}, (Operand){Addr_mode::IMPL_SHOW, NO_REG, 2}}, &Cpu::SET},
    (Instr){(Instr_args){"SET",0xCBD6, (Operand){Addr_mode::MEM_REG, HL}, (Operand){Addr_mode::IMPL_SHOW, NO_REG, 2}}, &Cpu::SET},
    (Instr){(Instr_args){"SET",0xCBD7, (Operand){Addr_mode::REG, A}, (Operand){Addr_mode::IMPL_SHOW, NO_REG, 2}}, &Cpu::SET},
    (Instr){(Instr_args){"SET",0xCBD8, (Operand){Addr_mode::REG, B}, (Operand){Addr_mode::IMPL_SHOW, NO_REG, 3}}, &Cpu::SET},
    (Instr){(Instr_args){"SET",0xCBD9, (Operand){Addr_mode::REG, C}, (Operand){Addr_mode::IMPL_SHOW, NO_REG, 3}}, &Cpu::SET},
    (Instr){(Instr_args){"SET",0xCBDA, (Operand){Addr_mode::REG, D}, (Operand){Addr_mode::IMPL_SHOW, NO_REG, 3}}, &Cpu::SET},
    (Instr){(Instr_args){"SET",0xCBDB, (Operand){Addr_mode::REG, E}, (Operand){Addr_mode::IMPL_SHOW, NO_REG, 3}}, &Cpu::SET},
    (Instr){(Instr_args){"SET",0xCBDC, (Operand){Addr_mode::REG, H}, (Operand){Addr_mode::IMPL_SHOW, NO_REG, 3}}, &Cpu::SET},
    (Instr){(Instr_args){"SET",0xCBDD, (Operand){Addr_mode::REG, L}, (Operand){Addr_mode::IMPL_SHOW, NO_REG, 3}}, &Cpu::SET},
    (Instr){(Instr_args){"SET",0xCBDE, (Operand){Addr_mode::MEM_REG, HL}, (Operand){Addr_mode::IMPL_SHOW, NO_REG, 3}}, &Cpu::SET},
    (Instr){(Instr_args){"SET",0xCBDF, (Operand){Addr_mode::REG, A}, (Operand){Addr_mode::IMPL_SHOW, NO_REG, 3}}, &Cpu::SET},
    (Instr){(Instr_args){"SET",0xCBE0, (Operand){Addr_mode::REG, B}, (Operand){Addr_mode::IMPL_SHOW, NO_REG, 4}}, &Cpu::SET},
    (Instr){(Instr_args){"SET",0xCBE1, (Operand){Addr_mode::REG, C}, (Operand){Addr_mode::IMPL_SHOW, NO_REG, 4}}, &Cpu::SET},
    (Instr){(Instr_args){"SET",0xCBE2, (Operand){Addr_mode::REG, D}, (Operand){Addr_mode::IMPL_SHOW, NO_REG, 4}}, &Cpu::SET},
    (Instr){(Instr_args){"SET",0xCBE3, (Operand){Addr_mode::REG, E}, (Operand){Addr_mode::IMPL_SHOW, NO_REG, 4}}, &Cpu::SET},
    (Instr){(Instr_args){"SET",0xCBE4, (Operand){Addr_mode::REG, H}, (Operand){Addr_mode::IMPL_SHOW, NO_REG, 4}}, &Cpu::SET},
    (Instr){(Instr_args){"SET",0xCBE5, (Operand){Addr_mode::REG, L}, (Operand){Addr_mode::IMPL_SHOW, NO_REG, 4}}, &Cpu::SET},
    (Instr){(Instr_args){"SET",0xCBE6, (Operand){Addr_mode::MEM_REG, HL}, (Operand){Addr_mode::IMPL_SHOW, NO_REG, 4}}, &Cpu::SET},
    (Instr){(Instr_args){"SET",0xCBE7, (Operand){Addr_mode::REG, A}, (Operand){Addr_mode::IMPL_SHOW, NO_REG, 4}}, &Cpu::SET},
    (Instr){(Instr_args){"SET",0xCBE8, (Operand){Addr_mode::REG, B}, (Operand){Addr_mode::IMPL_SHOW, NO_REG, 5}}, &Cpu::SET},
    (Instr){(Instr_args){"SET",0xCBE9, (Operand){Addr_mode::REG, C}, (Operand){Addr_mode::IMPL_SHOW, NO_REG, 5}}, &Cpu::SET},
    (Instr){(Instr_args){"SET",0xCBEA, (Operand){Addr_mode::REG, D}, (Operand){Addr_mode::IMPL_SHOW, NO_REG, 5}}, &Cpu::SET},
    (Instr){(Instr_args){"SET",0xCBEB, (Operand){Addr_mode::REG, E}, (Operand){Addr_mode::IMPL_SHOW, NO_REG, 5}}, &Cpu::SET},
    (Instr){(Instr_args){"SET",0xCBEC, (Operand){Addr_mode::REG, H}, (Operand){Addr_mode::IMPL_SHOW, NO_REG, 5}}, &Cpu::SET},
    (Instr){(Instr_args){"SET",0xCBED, (Operand){Addr_mode::REG, L}, (Operand){Addr_mode::IMPL_SHOW, NO_REG, 5}}, &Cpu::SET},
    (Instr){(Instr_args){"SET",0xCBEE, (Operand){Addr_mode::MEM_REG, HL}, (Operand){Addr_mode::IMPL_SHOW, NO_REG, 5}}, &Cpu::SET},
    (Instr){(Instr_args){"SET",0xCBEF, (Operand){Addr_mode::REG, A}, (Operand){Addr_mode::IMPL_SHOW, NO_REG, 5}}, &Cpu::SET},
    (Instr){(Instr_args){"SET",0xCBF0, (Operand){Addr_mode::REG, B}, (Operand){Addr_mode::IMPL_SHOW, NO_REG, 6}}, &Cpu::SET},
    (Instr){(Instr_args){"SET",0xCBF1, (Operand){Addr_mode::REG, C}, (Operand){Addr_mode::IMPL_SHOW, NO_REG, 6}}, &Cpu::SET},
    (Instr){(Instr_args){"SET",0xCBF2, (Operand){Addr_mode::REG, D}, (Operand){Addr_mode::IMPL_SHOW, NO_REG, 6}}, &Cpu::SET},
    (Instr){(Instr_args){"SET",0xCBF3, (Operand){Addr_mode::REG, E}, (Operand){Addr_mode::IMPL_SHOW, NO_REG, 6}}, &Cpu::SET},
    (Instr){(Instr_args){"SET",0xCBF4, (Operand){Addr_mode::REG, H}, (Operand){Addr_mode::IMPL_SHOW, NO_REG, 6}}, &Cpu::SET},
    (Instr){(Instr_args){"SET",0xCBF5, (Operand){Addr_mode::REG, L}, (Operand){Addr_mode::IMPL_SHOW, NO_REG, 6}}, &Cpu::SET},
    (Instr){(Instr_args){"SET",0xCBF6, (Operand){Addr_mode::MEM_REG, HL}, (Operand){Addr_mode::IMPL_SHOW, NO_REG, 6}}, &Cpu::SET},
    (Instr){(Instr_args){"SET",0xCBF7, (Operand){Addr_mode::REG, A}, (Operand){Addr_mode::IMPL_SHOW, NO_REG, 6}}, &Cpu::SET},
    (Instr){(Instr_args){"SET",0xCBF8, (Operand){Addr_mode::REG, B}, (Operand){Addr_mode::IMPL_SHOW, NO_REG, 7}}, &Cpu::SET},
    (Instr){(Instr_args){"SET",0xCBF9, (Operand){Addr_mode::REG, C}, (Operand){Addr_mode::IMPL_SHOW, NO_REG, 7}}, &Cpu::SET},
    (Instr){(Instr_args){"SET",0xCBFA, (Operand){Addr_mode::REG, D}, (Operand){Addr_mode::IMPL_SHOW, NO_REG, 7}}, &Cpu::SET},
    (Instr){(Instr_args){"SET",0xCBFB, (Operand){Addr_mode::REG, E}, (Operand){Addr_mode::IMPL_SHOW, NO_REG, 7}}, &Cpu::SET},
    (Instr){(Instr_args){"SET",0xCBFC, (Operand){Addr_mode::REG, H}, (Operand){Addr_mode::IMPL_SHOW, NO_REG, 7}}, &Cpu::SET},
...
bool Cpu::step(){
    ...
    if(this->state == RUNNING){
        ...
        //std::cout<<"exec time: "<<std::chrono::duration_cast<std::chrono::microseconds>(exec_time - tick_time).count()<<std::endl;
...
void Cpu::write_to_operand_8bit(Operand& op, u16 value, Addr_mode src_addr){
    value &= 0xFF;
    int ticks_to_add = 0;
    int add_to_pc = 0;
    switch(op.addr_mode){
...
void Cpu::write_to_operand_16bit(Operand& op, u16 value, Addr_mode src_addr){
    int ticks_to_add = 0;
    int add_to_pc = 0;
    switch(op.addr_mode){
...
void Cpu::write_to_operand(Operand&op, u16 value, Addr_mode src_addr){
    if (!is_16bit_src(src_addr)){
        write_to_operand_8bit(op, value, src_addr);
    }
    else{ //Assuming there is no broken instruction
        write_to_operand_16bit(op, value, src_addr);
    }
}
...
std::string Cpu::toString(){
    ...
    if (this->state == RUNNING){
        if (this->mem.readX(this->regs[PC]) != 0xCB){
            ...
            str += this->instr_toString(Cpu::instr_table[this->mem.readX(this->regs[PC])]);
        }
        else{
            this->regs[PC]++;
            str += numToHexString(0xCB00+this->mem.readX(this->regs[PC]), 4) + " ==> ";
            str += this->instr_toString(Cpu::instr_table_prefix[this->mem.readX(this->regs[PC])]);
            this->regs[PC]--;
        }
    }
    return str;
...
void Cpu::JP(Instr_args args){
    ...
    */
    ...
    if (args.variant >=2 && args.cond != Cond::ALWAYS) run_ticks(1);
